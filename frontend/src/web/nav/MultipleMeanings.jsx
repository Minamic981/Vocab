...
export default function MultipleMeanings({ fetchWithRetry, addToast }) {
  ...
  }, [addEn, addFa, addAlts, addStyleEnabled, addStyle, addCustomStyle, addCat, fetchWithRetry, addToast]);
